    ...
    if chat_entry.get():
        ...
        try:
            if os.path.isfile(filename):
                ...
                my_text.insert(END, "\n\nYou Need An API Key To Talk With TismBot. Get One Here--->\nhttps://beta.openai.com/account/api-keys")
